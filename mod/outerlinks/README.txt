...
Към страницата, показваща интернет връзки може да се изпрати параметър $_GET['just']=='data' и тогава вместо интернет страница се генерира json, от данните на записа с номер $_GET['lid'] Това се използва от модул OUTERLINK за извличане на данни от друг сървър, на който се използва настоящата система mycms и модул OUTERLINKS.

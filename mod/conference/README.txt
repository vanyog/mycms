...
1. Лична страница на участник в конференцията, от която той избира да:
...
8. Страница за изпращане на съобщения
   Съдържаща елемент: <!--$$_CONFERENCE_review|типПотребител_$$-->

За правилното функциониране на модула:
   Съдържаща елемент: <!--$$_FEEDBACK_типПотребител_$$-->
...
'conference_day_a_submit' - ID от таблица 'schedules' - срок за предаване на резюмета
'conference_day_a_approve' - ID от 'schedules' - срок за потвърждаване на резюметата
...
'conference_topics_'.'conference_usertype' - PHP код, дефиниция на променлива $tp = array(); - масив от стрингове с имената на научните секции (тематични направления) на конференцията.
...
fulltextfile3 - файл с презентация
fulltextfile4 - pdf файл на пълния текст със заличени автори за анонимно рецензиране
vol - том
pages - брой страници
...
$tnprefix.'reviewer_work' - подадени от рецензентите рецензии
ID - идент. номер, първичен ключ, autoincrement 
date_time_1 - дата на създаване на записа
date_time_2 - дата на последна промяна
rev_id - ID номер на рецензента от таблица 'reviewers'
proc_id - ID номер на публикация от таблица 'proceeddings'
grade1, grade2, grade3, grade4, grade5, grade6, grade7, grade8, grade9, grade10, grade11, grade12 - оценки по различни критерии
decision - предложение на рецензента за публикуване
again - дали иска да провери корекциите на автора
comment1 - общ коментар по публикацията
comment2 - забележки, които трябва да се отстранят за да се публикува
comment3 - забележки след направени корекции
final - окончателно решение след поправките
locked - заключване на рецензията за по-нататъшно редактиране
...
3. За новата конференция, освен страниците с обща информация, достъпни за всички посетители, се създават страници за:
 ...
 - преглеждане на регистрациите от администратор
   ...
   <!--$$_CONFERENCE_admin_$$-->
   За администриране, може и да не се създава нова страница, ако вече има такава от предишна конференция. Достатъчно е само, ако е необходимо, да се смени шаблона на страницата от предишна конференция с нов шаблон, използван на страниците на новата конференция.
...
4. Посредством модул SCHEDULES се въвеждат важните дати на конференцията и съответно се задавет ID-тата на събитията в таблица 'options'

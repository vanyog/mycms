...
1. Лична страница на участника в конференцията, от която той:
   ...
   - редактира резюметата на двата доклада, на които има право;
...
3. Страница за показване на одобрените резюмета.
...
'conference_files' - адрес на директория, в която участниците качват .doc и .pdf файлове с пълния текст на докладите.

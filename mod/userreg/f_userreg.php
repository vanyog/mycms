...
// Действието на функцията се определя и от стойността на параметъра $_GET['user2']
// 'newreg' - нова регистрация или смяна на паролата
// 'login' - влизане
// 'logout' - излизане
// 'edit' - редактиране на данните

// Ако няма параметър $_GET['user2'], при наличие на влязъл валиден потребител от съответния тип

...
Ако сайтът е снабден със SSL сертификат и влизането на потребителите трябва да става през https се в таблица $tn_prefix.'options' се задава и настройка 'userreg_https' със стойност 'on'.

Саморегистриращите се потребители се разделят на типове. Типът на всеки потребител е кратък стринг,
който при създаване на нов потребител модулът записва в полето `type` на таблица $user_table.

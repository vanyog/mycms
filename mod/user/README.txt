...
Всяка такава функция трябва да проверява валидността на потребителско име и парола, например, в друга база данни. При условие, че са валидни да ги прибавя в таблица user_table и да установява променливи $_SESSION['user_username'] и $_SESSION['user_password'].

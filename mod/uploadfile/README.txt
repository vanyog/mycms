...
uploadfile_atherroot - използва се, когато сайтът се премества на друг сървър. Тогава в базата данни ще стоят пътищата до тях от стария сървър. За да бъдат разпознати на новия сървър се задава тази настройка, която съдържа пътя до document_root директорията на стария сървър.
...
ss - стриг, който започва задължително със 'style="' и съдържа CSS дефиниции за форматиране на <a> или <img> елемента за показване на файла.

В нормален режим на мястото на горния елемент се показва хипервръзка към качения файл, или изображение, ако файлът е изображение. Ако още не е качен файл се показва надпис както е зададено с опция tt, или ако не е зададена - надпис "Няма качен файл" или не се показва нищо ако опция uploadfile_nofilenotext е 'true'.

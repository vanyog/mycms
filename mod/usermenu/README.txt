...
се показва меню, с действия, които, влязъл в сайта потребител има право да извършва. Част от тези действия се изпълняват от този модул: редактиране на текст; създаване/изтриване, скриване/показване на страница; вмъкване в съдържанието на една страница, това на друга страница; редактиране на линк от меню. Други действия се извършват чрез други модули. Елементът <!--$$_USERMENU_$$--> се вмъква в най-долната част на html кода, преди </body>, а разположението му върху страниците се управлява с css. Някои действия по редактиране на съдържание може да се извършват и с интерфейсни елементи, показвани върху страницата, а не с команди от менюто.

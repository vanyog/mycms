...
- редактирането на всички файлове и данни на сайта може да се извършва само с помощта на браузър; редакторът, който се използва за тази цел, показва програмен код, но има възможност да се ползва и WYSIWYG редактор, по подразбиране CKEditor (https://ckeditor.com)

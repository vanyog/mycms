...
Идията за променлива $added_styles е тя да се използва за съхраняване на CSS правила, които се добавят от други модули и функции, само когато в дадена страница се използват тези модули. Добавянето на CSS правила се извършва от функция add_style(имеНаСтил) от файл lib/f_add_style.php. Тази функция добавя към променлива $added_styles, правилата формулирани в опция с име 'css_имеНаСтил'. Списък на тези опции и възможност за редактирането им дава файл manage/edit_styles.php.

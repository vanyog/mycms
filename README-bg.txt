...
Този README-bg.txt файл съдържа кратко общо описание на системата и към момента е съществена част от документация по нея.
...
Общота концепция е следната: Съдържанието на всички страници се съхранява в базата данни и се генерира с помощта на шаблони и PHP скриптове за генериране на html код.
...
По желание, приемливи за SEO адреси, не съдържащи символи ?, & и =, се постигат чрез RewriteEngine на Apache сървъра. Ако се използва RewriteEngine на Apache, трябва в таблица $tn_prefix.'options' да се зададе опция с име 'RewriteEngine' и стойност 'on'. При наличие на тази опция модулите, които генерират адреси, например: SITEMAP, OUTERLINKS и др., следва да генерират SEO адреси. Тази идея още не е ползвана на работещи сайтове и не е реализирана напълно.

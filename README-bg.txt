...
Указания за ползване на системата ще намерите във файл USEAGE.txt, и на адрес https://github.com/vanyog/mycms/wiki
...
- редактирането на всички файлове и данни на сайта може да се извършва само с помощта на Интернет браузър; редакторът, който се използва за тази цел, показва първичен код, но има възможност да се ползва и WYSIWYG редактор, например CKEditor (https://ckeditor.com)
...
- независимост на модулите и функциите - желанието е всеки модул да може да се използва и "без цялата системата", само с include() да се декларира съответния файл и да се ползват дефиниранети в този фаял функции
...
- Последователността на вмъкване на шаблони се описва с редове от вида: Template(X) Y, където X е число, номер на шаблон, а Y брой на изпълнените до момента заявки към базата данни.
- Последователността на извикване на скриптове и модули във вида: Module XXX(P) Y, където XXX е име на модул, P параметър, предаден на главната функция на модула, Y  брой на изпълнените до момента заявки към базата данни.
...
--------------------
name - име на текста. Ако е '*' списъкът от филтри се прилагам върху всечки стринговете представляващи съдържание на страници.

...
Имената XXXX в елементите от вида <!--$$_XXXX_$$-->, които се заместват с друг html код са имена на модули или имена на PHP скриптовете, които се съхраняват в таблица $tn_prefix.'scripts' и се изпълняват се с функцията eval(). 

...
(Глобалната за системата променлива $tn_prefix, съдържа представка към имената на таблиците в базата данни, зададена е във файл conf_database.php.)

Настройките, с изключение на данните за достъп до базата данни, се съхраняват в таблица $tn_prefix.'options' и съответно се четат и записват с функциите stored_value($n) и store_value($n,$v), дефинирани във файл lib/f_stored_value.php.
...
Преди инсталиране на системата и установяване на връзка с базата данни, показваните от инсталиращия скрипт manage/_install.php надписи се зареждат с PHP функциите за GNU gettext (https://www.php.net/manual/en/ref.gettext.php). Всички надписи, които подлежат на превеждане са заградени в _(" "). Поддържането на файл manage/locale/bg_BG/LC_MESSAGE/_install.po се осъществява с помощта на приложението Poedit (https://poedit.net).

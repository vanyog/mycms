...
// Функцията db_update_where($d,$t,$w) опреснява записите в таблица $t
// с данните от масив $d, ако записите отговарят на условието $w.

// Ако към функцията е изпратен четвърти параметър $y = true
